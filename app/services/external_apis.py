...
class ExternalAPIService:
    ...
    def get_insider_trading(ticker, limit=10):
        ...
        """
        try:
            # Financial Modeling Prep - gratis tier
            api_key = os.environ.get('FMP_API_KEY', 'demo')  # Gratis demo key
        ...
        return ExternalAPIService._get_fallback_insider_data(ticker)
    ...
    def _get_fallback_insider_data(ticker):
        """Fallback insider trading data for demo"""
        return [
            {
                'filing_date': '2024-06-25',
                'transaction_date': '2024-06-23',
                'reporting_name': 'CEO John Smith',
                'relationship': 'Chief Executive Officer',
                'transaction_type': 'P-Purchase',
                'securities_owned': 150000,
            ...
            },
            {
                ...
                'reporting_name': 'CFO Sarah Johnson',
                'relationship': 'Chief Financial Officer',
                'transaction_type': 'S-Sale',
                'securities_owned': 75000,
                'securities_transacted': 2500,
                'price': 128.75,
                'acquired_disposed': 'D',
                'form_type': '4',
                'ticker': ticker
        ...
        return [
            {
                ...
                'analyst_company': 'Nordic Securities',
                'recommendation': 'BUY',
                'recommendation_mean': 1.5,
                'target_price': 380.0,
                'current_price': 342.55,
                'upside_potential': 10.9,
                'date': datetime.now().strftime('%Y-%m-%d'),
                'ticker': ticker
            },
            {
                'analyst_name': 'Sarah Johnson',
                'analyst_company': 'Skandia Markets',
                'recommendation': 'HOLD',
