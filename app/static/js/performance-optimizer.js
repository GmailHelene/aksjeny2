...
class PerformanceOptimizer {
    ...
    renderTable(container, data) {
        if (!Array.isArray(data) || data.length === 0) {
            container.innerHTML = '<div class="alert alert-info"><i class="bi bi-arrow-clockwise me-2"></i>Laster markedsdata...</div>';
            return;
        }
    ...
    renderTopMovers(container, data) {
        if (!Array.isArray(data) || data.length === 0) {
            container.innerHTML = '<div class="alert alert-info"><i class="bi bi-graph-up me-2"></i>Analyserer markedsbevegelser...</div>';
            return;
        }
