...
You reached the start of the range → Aug 7, 2025, 12:49 AM

    raise BuildError(endpoint, values, method, self)

werkzeug.routing.exceptions.BuildError: Could not build url for endpoint 'portfolio.edit' with values ['id']. Did you mean 'portfolio.edit_stock' instead?
...
Traceback (most recent call last):
  ...
  File "/app/app/routes/portfolio.py", line 483, in view_portfolio
  ...
  File "/usr/local/lib/python3.10/site-packages/flask/app.py", line 1084, in url_for

    return self.handle_url_build_error(error, endpoint, values)

  File "/usr/local/lib/python3.10/site-packages/flask/app.py", line 1073, in url_for

    rv = url_adapter.build(  # type: ignore[union-attr]

  File "/usr/local/lib/python3.10/site-packages/werkzeug/routing/map.py", line 924, in build

    raise BuildError(endpoint, values, method, self)

werkzeug.routing.exceptions.BuildError: Could not build url for endpoint 'portfolio.portfolio_index'. Did you mean 'portfolio.view_portfolio' instead?

[2025-08-06 23:01:01,486] ERROR in portfolio: Critical error in portfolio overview: Could not build url for endpoint 'portfolio.view' with values ['id']. Did you mean 'portfolio.overview' instead?

ERROR:app:Critical error in portfolio overview: Could not build url for endpoint 'portfolio.view' with values ['id']. Did you mean 'portfolio.overview' instead?

[2025-08-06 23:14:37,377] ERROR in pro_tools: Error loading pro tools index: Could not build url for endpoint 'analysis.advanced'. Did you mean 'analysis.ai' instead?

ERROR:app.routes.pro_tools:Error loading pro tools index: Could not build url for endpoint 'analysis.advanced'. Did you mean 'analysis.ai' instead?

[2025-08-06 23:31:26,940] ERROR in analysis: Error in sentiment analysis: analysis/_menu                    {% if sentiment_data.news_sentiment_articles %}

                    <div class="mb-3">

                        {% for news in sentiment_data.news_sentiment_articles[:5] %}ml

ERROR:app.routes.analysis:Error in sentiment analysis: analysis/_menu                    {% if sentiment_data.news_sentiment_articles %}

                    <div class="mb-3">

                        {% for news in sentiment_data.news_sentiment_articles[:5] %}ml

WARNING:root:[ACCESS_REQUIRED] Unauthenticated user, redirecting to demo

[2025-08-06 23:46:18,020] ERROR in pro_tools: Error loading pro tools index: Could not build url for endpoint 'analysis.advanced'. Did you mean 'analysis.ai' instead?

ERROR:app.routes.pro_tools:Error loading pro tools index: Could not build url for endpoint 'analysis.advanced'. Did you mean 'analysis.ai' instead?

[2025-08-06 23:46:31,805] ERROR in pro_tools: Error loading pro tools index: Could not build url for endpoint 'analysis.advanced'. Did you mean 'analysis.ai' instead?

ERROR:app.routes.pro_tools:Error loading pro tools index: Could not build url for endpoint 'analysis.advanced'. Did you mean 'analysis.ai' instead?

[2025-08-07 00:09:41,176] ERROR in analysis: Error in sentiment analysis: analysis/_menu                    {% if sentiment_data.news_sentiment_articles %}
...
web | Railway@analysis.route('/fundamental', methods=['GET', 'POST'])
    ...
    try:
        ...
        if ticker and ticker.strip():
            ...
            fundamental_data = {
                ...
                'revenue_growth': 12.4,  # Add this for template compatibility
                'eps_growth': 15.2,     # Add this for template compatibility
                'financial_metrics': {
                    'pe_ratio': 24.5,
                    'peg_ratio': 1.2,
                    'price_to_book': 3.8,
                    'debt_to_equity': 0.65,
                    'roe': 18.5,  # Return on Equity as percentage
                    'roa': 12.3,  # Return on Assets as percentage
                    'current_ratio': 1.8,
                    'quick_ratio': 1.4,
                    'profit_margin': 21.2,
