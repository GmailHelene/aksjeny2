                ...
                if user_id:
                    ...
                    for i, fav in enumerate(favorites):
                        ...
                        if not display_name or display_name.strip() == '':
                            # Try to get name from DataService if available
                            try:
                                from ..services.data_service import DataService
                                ...
                                if stock_info and stock_info.get('name'):
                                    ...
                                    display_name = fav.symbol  # Final fallback to symbol
                            except Exception:
                                display_name = fav.symbol  # Fallback to symbol
                        ...
                        if not exchange or exchange.strip() == '':
                            ...
                            if fav.symbol.endswith('.OL'):
                                ...
                                exchange = 'NASDAQ/NYSE'  # US stocks typically have no suffix
                            else:
                                exchange = 'Unknown'
                        ...
                        logger.info(f"Step 6.{i}: Added {fav.symbol} ({display_name}) to user_favorites list")
