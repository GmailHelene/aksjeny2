...
@access_required  # Changed from @login_required to require subscription
def overview():
    ...
    try:
        ...
        for portfolio_obj in user_portfolios:
            try:
                ...
                # Add portfolio totals to overall totals
...
@access_required
def add_stock():
    """Add a stock to the user's default portfolio, supporting pre-fill from symbol query param"""
    if request.method == 'POST':
        ticker = request.form.get('ticker')
