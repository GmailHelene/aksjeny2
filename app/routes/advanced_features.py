...
@advanced_features.route('/advanced-analysis')
@access_required
def advanced_analysis():
    """Advanced market analysis and insights"""
    try:
        # Ensure services are available
        if not external_data_service or not competitive_service:
            raise RuntimeError("Required services are not initialized")
        ...
        # Market overview
        try:
            analysis_data['market_overview'] = external_data_service.get_global_markets_overview()
        except Exception as e:
            logger.error(f"Error getting market overview: {e}")
            analysis_data['market_overview'] = {
        ...
        # Sector analysis
        try:
            analysis_data['sector_analysis'] = external_data_service.get_sector_performance()
        except Exception as e:
            logger.error(f"Error getting sector analysis: {e}")
            analysis_data['sector_analysis'] = {
                'sectors': {},
                'trends': {},
                'error': True
            }
        ...
        # Economic indicators
        try:
            analysis_data['economic_indicators'] = external_data_service.get_economic_indicators()
        except Exception as e:
            logger.error(f"Error getting economic indicators: {e}")
            analysis_data['economic_indicators'] = {
                'indicators': {},
                'error': True
            }
        ...
        # Technical analysis
        try:
            analysis_data['technical_analysis'] = competitive_service.get_technical_overview()
        except Exception as e:
        ...
        # Sentiment analysis
        try:
            analysis_data['sentiment_analysis'] = competitive_service.get_market_sentiment()
        except Exception as e:
        ...
        return render_template('advanced_features/advanced_analysis.html',
        ...
        return render_template('advanced_features/advanced_analysis.html',
                             analysis={},
                             error="Advanced analyse er midlertidig utilgjengelig")
