...
print("1. Gå til: http://localhost:5002/auth ELLER http://localhost:5002/login")
...
print("2. Prøv å navigere direkt til: http://localhost:5002/auth")
...
print("3. Dette bør ta deg til: http://localhost:5002/forgot_password")
...
print("- Sjekk app kjører: curl http://localhost:5002")
