#!/usr/bin/env python3
"""
Hotfix: Temporarily disable problematic database columns
"""
import os
import sys
sys.path.append(os.path.dirname(os.path.abspath(__file__)))

def create_hotfix_user_model():
    """Create a hotfix version of user.py without problematic columns"""
    
    hotfix_content = '''from ..extensions import db, login_manager
...
'''
    ...
    # Write the hotfix file
    with open('/workspaces/aksjeny/app/models/user_hotfix.py', 'w') as f:
        f.write(hotfix_content)
    
    print("✅ Hotfix user model created at app/models/user_hotfix.py")

if __name__ == '__main__':
    create_hotfix_user_model()
