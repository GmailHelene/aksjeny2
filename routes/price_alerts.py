...
price_alerts_bp = Blueprint('price_alerts', __name__, url_prefix='/price-alerts')

@price_alerts_bp.route('/')
@access_required
def index():
...
@price_alerts_bp.route('/delete/<int:alert_id>', methods=['POST'])
@access_required
def delete(alert_id):
...
@price_alerts_bp.route('/settings', methods=['GET', 'POST'])
@access_required
def settings():
...
# API Endpoints
@price_alerts_bp.route('/api/alerts')
@access_required
def api_get_alerts():
...
@price_alerts_bp.route('/api/create', methods=['POST'])
@access_required
...
@price_alerts_bp.route('/api/delete/<int:alert_id>', methods=['DELETE'])
@access_required
...
@price_alerts_bp.route('/api/status')
@access_required
...
@price_alerts_bp.route('/api/quote/<symbol>')
@access_required
